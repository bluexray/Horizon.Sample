...
namespace Horizon.Payment.Alipay.Response
{
    ...
    /// </summary>
    public class KoubeiMarketingDataSmartactivityConfigResponse : AlipayResponse
    {
        /// <summary>
        ...
        /// 活动有效天数
        /// </summary>
        [JsonPropertyName("activity_valid_days")]
        public string ActivityValidDays { get; set; }

        /// <summary>
        /// 活动配置CODE
        /// </summary>
        [JsonPropertyName("config_code")]
        public string ConfigCode { get; set; }

        /// <summary>
        /// 活动人群对象，包含针对N天未消费的用户/所有用户
        /// </summary>
        [JsonPropertyName("crowd_group")]
        ...
        /// 券有效天数
        /// </summary>
        [JsonPropertyName("voucher_valid_days")]
