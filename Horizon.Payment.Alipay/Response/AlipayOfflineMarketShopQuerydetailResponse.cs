...
namespace Horizon.Payment.Alipay.Response
{
    ...
    /// </summary>
    public class AlipayOfflineMarketShopQuerydetailResponse : AlipayResponse
    {
        /// <summary>
        /// 门店详细地址，注：不含省市区
        /// </summary>
        ...
        /// </summary>
        [JsonPropertyName("create_channel")]
        ...
        /// 门店创建时间
        /// </summary>
        [JsonPropertyName("gmt_shop_create")]
        public string GmtShopCreate { get; set; }

        /// <summary>
        /// 门店修改时间
        /// </summary>
        [JsonPropertyName("gmt_shop_modified")]
        ...
        /// 其它资质证明图片集；支持多张，逗号分隔
        /// </summary>
        [JsonPropertyName("other_auth_images")]
        ...
        /// 经过加工后的门店收款二维码
        /// </summary>
        [JsonPropertyName("processed_qr_code")]
        public string ProcessedQrCode { get; set; }

        /// <summary>
        /// 门店运营归属人uid
        /// </summary>
        [JsonPropertyName("provider_xiaoer_uid")]
