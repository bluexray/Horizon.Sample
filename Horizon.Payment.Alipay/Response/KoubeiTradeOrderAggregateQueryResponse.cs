...
{
    /// <summary>
    /// KoubeiTradeOrderAggregateQueryResponse.
    /// </summary>
    public class KoubeiTradeOrderAggregateQueryResponse : AlipayResponse
    {
        /// <summary>
        /// 买家ID, 支付成功时才返回
        /// </summary>
        ...
        /// <summary>
        /// 付款用户类型； 支付宝UID(ALIPAY_UID)/微信(WECHAT_OPENID)，支付成功时才返回
        /// </summary>
        ...
        /// <summary>
        /// SUCCESS - 支付成功 PROCESSING-支付处理中 CLOSED-超时未支付关单 REFUNDED-已退款
        /// </summary>
