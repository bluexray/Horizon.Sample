...
{
    /// <summary>
    /// alipay.fund.trans.thirdparty.reward.create
    /// </summary>
    public class AlipayFundTransThirdpartyRewardCreateRequest : IAlipayRequest<AlipayFundTransThirdpartyRewardCreateResponse>
    {
        /// <summary>
