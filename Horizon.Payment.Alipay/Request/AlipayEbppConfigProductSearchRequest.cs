...
{
    /// <summary>
    /// alipay.ebpp.config.product.search
    /// </summary>
    public class AlipayEbppConfigProductSearchRequest : IAlipayRequest<AlipayEbppConfigProductSearchResponse>
    {
        /// <summary>
