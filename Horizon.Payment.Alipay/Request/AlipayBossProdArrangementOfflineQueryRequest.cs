...
{
    /// <summary>
    /// alipay.boss.prod.arrangement.offline.query
    /// </summary>
    public class AlipayBossProdArrangementOfflineQueryRequest : IAlipayRequest<AlipayBossProdArrangementOfflineQueryResponse>
    {
        /// <summary>
