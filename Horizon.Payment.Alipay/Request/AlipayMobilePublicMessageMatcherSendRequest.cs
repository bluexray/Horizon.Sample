...
{
    /// <summary>
    /// alipay.mobile.public.message.matcher.send
    /// </summary>
    public class AlipayMobilePublicMessageMatcherSendRequest : IAlipayRequest<AlipayMobilePublicMessageMatcherSendResponse>
    {
        /// <summary>
