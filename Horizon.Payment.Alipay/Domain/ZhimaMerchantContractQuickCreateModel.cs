...
{
    /// <summary>
    /// ZhimaMerchantContractQuickCreateModel Data Structure.
    /// </summary>
    public class ZhimaMerchantContractQuickCreateModel : AlipayObject
    {
        /// <summary>
        ...
        /// 外部内容名称
        /// </summary>
        [JsonPropertyName("out_content_name")]
        public string OutContentName { get; set; }
