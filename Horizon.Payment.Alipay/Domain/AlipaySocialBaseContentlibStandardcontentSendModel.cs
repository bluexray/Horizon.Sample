...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    public class AlipaySocialBaseContentlibStandardcontentSendModel : AlipayObject
    {
        ...
        /// <summary>
        /// extInfo为扩展信息，json格式。 ugc和pgc区分：扩展字段中增加参数标识内容为PGC或UGC，格式为"createType":"ugc" 或者 "createType":"pgc"
        /// </summary>
        ...
        /// </summary>
        [JsonPropertyName("source_author")]
        ...
        /// </summary>
        [JsonPropertyName("source_keywords")]
        ...
        /// </summary>
        [JsonPropertyName("source_thumbnail_type")]
        ...
        /// </summary>
        [JsonPropertyName("source_thumbnails")]
        public string SourceThumbnails { get; set; }

        /// <summary>
        /// source_title是来源方文章标题，当action_type是publish时，必填。 针对没有标题的内容，如雪球传固定文案：雪球内容+(发布时间戳)
        /// </summary>
