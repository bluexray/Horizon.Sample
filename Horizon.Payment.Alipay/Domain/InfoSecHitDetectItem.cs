...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    /// </summary>
    public class InfoSecHitDetectItem : AlipayObject
    {
        /// <summary>
        /// 级别
        /// </summary>
        [JsonPropertyName("detect_resource_level")]
