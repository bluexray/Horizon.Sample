...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    /// </summary>
    public class IsvShopDishModel : AlipayObject
    {
        /// <summary>
        ...
        /// </summary>
        [JsonPropertyName("good_level")]
        public string GoodLevel { get; set; }

        /// <summary>
        /// 当前店铺的商家最近7天销量（份）
        /// </summary>
        [JsonPropertyName("merchant_sold_cnt_seven_d")]
        public long MerchantSoldCntSevenD { get; set; }

        /// <summary>
        /// 当前店铺的商家最近30天销量（份）
        /// </summary>
        [JsonPropertyName("merchant_sold_cnt_thirty_d")]
        public long MerchantSoldCntThirtyD { get; set; }

        /// <summary>
        /// 当前店铺的商家最近30天购买2次及以上的支付宝用户数
        /// </summary>
        [JsonPropertyName("merchant_sold_reusercnt_thirty_d")]
        public long MerchantSoldReusercntThirtyD { get; set; }

        /// <summary>
        /// 当前店铺的商家最近30天消费支付宝用户数
        /// </summary>
        [JsonPropertyName("merchant_sold_usercnt_thirty_d")]
        ...
        /// </summary>
        [JsonPropertyName("outer_dish_id")]
        ...
        /// 当前店铺最近7天销量（份）
        /// </summary>
        [JsonPropertyName("sold_cnt_seven_d")]
        public long SoldCntSevenD { get; set; }

        /// <summary>
        /// 当前店铺最近30天销量（份）
        /// </summary>
        [JsonPropertyName("sold_cnt_thirty_d")]
        public long SoldCntThirtyD { get; set; }

        /// <summary>
        /// 当前店铺最近30天购买2次及以上的支付宝用户数
        /// </summary>
        [JsonPropertyName("sold_reusercnt_thirty_d")]
        public long SoldReusercntThirtyD { get; set; }

        /// <summary>
        /// 当前店铺最近30天消费支付宝用户数
        /// </summary>
        [JsonPropertyName("sold_usercnt_thirty_d")]
