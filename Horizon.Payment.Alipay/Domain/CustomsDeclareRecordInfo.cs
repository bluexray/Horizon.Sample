...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    /// </summary>
    public class CustomsDeclareRecordInfo : AlipayObject
    {
        /// <summary>
        /// 支付宝报关流水号。
        /// </summary>
