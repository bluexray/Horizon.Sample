...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    public class KoubeiCateringOrderSyncModel : AlipayObject
    {
        ...
        /// 在线支付金额
        /// </summary>
        [JsonPropertyName("koubei_payment_amount")]
        public string KoubeiPaymentAmount { get; set; }

        /// <summary>
        /// POS支付的金额，为POS侧支付成功的订单金额之和；
        /// </summary>
        [JsonPropertyName("offline_payment_amount")]
        ...
        /// 订单累计已支付金额
        /// </summary>
        [JsonPropertyName("total_paymented_amount")]
        ...
        /// </summary>
        [JsonPropertyName("use_online_promotion_flag")]
