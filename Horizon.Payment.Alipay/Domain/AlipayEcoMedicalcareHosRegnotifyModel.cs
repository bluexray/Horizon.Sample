...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    /// </summary>
    public class AlipayEcoMedicalcareHosRegnotifyModel : AlipayObject
    {
        /// <summary>
        ...
        /// 科室信息
        /// </summary>
        [JsonPropertyName("dept_info")]
        public MedicalHospitalDeptInfo DeptInfo { get; set; }

        /// <summary>
        /// 医生信息
        /// </summary>
        [JsonPropertyName("doctor_info")]
        ...
        /// </summary>
        [JsonPropertyName("treat_date_ext")]
