...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    public class AlipayEcoRenthouseLeaseOrderSyncModel : AlipayObject
    {
        ...
        /// </summary>
        [JsonPropertyName("furniture_items")]
        ...
        /// </summary>
        [JsonPropertyName("lease_create_time")]
        ...
        /// </summary>
        [JsonPropertyName("original_lease_code")]
        public string OriginalLeaseCode { get; set; }

        /// <summary>
        /// 其他费用描述
        /// </summary>
        [JsonPropertyName("other_fee_desc")]
