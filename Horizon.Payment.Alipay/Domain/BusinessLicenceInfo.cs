...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    public class BusinessLicenceInfo : AlipayObject
    {
        ...
        /// </summary>
        [JsonPropertyName("business_license_province")]
