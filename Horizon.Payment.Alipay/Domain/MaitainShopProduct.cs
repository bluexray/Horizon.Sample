...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    /// </summary>
    public class MaitainShopProduct : AlipayObject
    {
        /// <summary>
        /// 销售价格（元），服务售卖价格，展示给用户。无优惠时的下单支付金额。 新增：必填； 修改：可空
        /// </summary>
        [JsonPropertyName("off_price")]
        ...
        /// </summary>
        [JsonPropertyName("out_privilege_id")]
        ...
        /// </summary>
        [JsonPropertyName("privilege_close_time")]
        ...
        /// </summary>
        [JsonPropertyName("privilege_price")]
        public string PrivilegePrice { get; set; }

        /// <summary>
        /// 优惠截止时间。格式"yyyy-MM-dd HH:mm:ss"  优惠有效时间，超过时间不再显示优惠价，下单使用销售价格。  新增：可空； 修改：可空  (out_privilege_id、privilege_start_time、privilege_close_time、privilege_tags、privilege_price必须同时存在)
        /// </summary>
        [JsonPropertyName("privilege_start_time")]
        ...
        /// </summary>
        [JsonPropertyName("privilege_tags")]
