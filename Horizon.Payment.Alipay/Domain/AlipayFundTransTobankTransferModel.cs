...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    /// </summary>
    public class AlipayFundTransTobankTransferModel : AlipayObject
    {
        /// <summary>
