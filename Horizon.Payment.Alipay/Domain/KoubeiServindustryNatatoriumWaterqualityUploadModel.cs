...
namespace Horizon.Payment.Alipay.Domain
{
    ...
    public class KoubeiServindustryNatatoriumWaterqualityUploadModel : AlipayObject
    {
        ...
        /// 当前场馆内人数更新时间
        /// </summary>
        [JsonPropertyName("currentnum_update_time")]
        ...
        /// </summary>
        [JsonPropertyName("water_change_standard")]
        public string WaterChangeStandard { get; set; }

        /// <summary>
        /// 水质监测时间
        /// </summary>
        [JsonPropertyName("water_check_time")]
