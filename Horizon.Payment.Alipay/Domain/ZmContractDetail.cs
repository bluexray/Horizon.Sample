...
{
    /// <summary>
    /// ZmContractDetail Data Structure.
    /// </summary>
    public class ZmContractDetail : AlipayObject
    {
        /// <summary>
        ...
        public List<BccEventDetail> EventDetail { get; set; }
        ...
        public List<BccSubjectDetail> Subjects { get; set; }
    }
}
